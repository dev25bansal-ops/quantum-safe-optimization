...
class MaxCutProblem(QAOAProblem):
    ...
    @classmethod
    def random_graph(cls, num_nodes: int, edge_probability: float = 0.5, seed: int = None) -> "MaxCutProblem":
...
class PortfolioProblem(QAOAProblem):
    ...
    def evaluate_solution(self, bitstring: str) -> float:
        ...
        return risk - self.risk_aversion * expected_return + self.penalty_weight * constraint_violation
