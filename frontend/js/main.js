...
function initAlgorithmTabs() {
    ...
    tabButtons.forEach(button => {
        button.addEventListener('click', () => {
            ...
            // Update tablist active descendant
            const tablist = button.closest('[role="tablist"]');
            if (tablist) {
                tablist.setAttribute('aria-activedescendant', button.id);
            }
        });
    });
}
 ...
 * Allows users to switch between dark and light themes on the landing page.
...
function initLandingThemeToggle() {
    ...
    updateLandingThemeIcon(btn, saved);
    ...
    btn.addEventListener('click', () => {
        ...
        updateLandingThemeIcon(btn, next);
    });
}

function updateLandingThemeIcon(btn, theme) {
