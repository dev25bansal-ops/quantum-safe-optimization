...
from qsop.crypto.pqc import KEMAlgorithm, get_kem_provider, KEMProvider
from qsop.crypto.symmetric import AEADAlgorithm, get_aead_cipher, derive_key
...
class EnvelopeEncryptor:
    ...
    def __init__(
        ...
        kem_provider: Optional[KEMProvider] = None,
    ):
        """
    ...
    def encrypt(
        ...
        for recipient in recipients:
            ...
            processed_recipients.append(RecipientInfo(
...
class EnvelopeDecryptor:
    ...
    def decrypt(
        ...
        # Build AAD (need original recipient public keys)
        recipient_public_keys = None
        if public_key:
            # For single recipient, we can reconstruct
        ...
        encrypted = EncryptedData(
            ...
            tag=envelope.ciphertext[-16:],  # Tag is last 16 bytes
