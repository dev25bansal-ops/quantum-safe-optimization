        ...
        *,
        ...
        for gen in range(self.config.generations):
            ...
            offspring_fitness = np.array([
                problem.evaluate(ind) for ind in offspring
            ])
        ...
        param_dict = {
            problem.variables[i].name: float(best_solution[i])
        ...
        *,
        ...
        for gen in range(self.config.generations):
            for i in range(self.config.population_size):
                ...
                mutant = best + self.config.mutation_factor * (
...
class ParticleSwarmOptimization(BaseClassicalOptimizer):
    ...
    def optimize(
        ...
        *,
        ...
        param_dict = {
            problem.variables[i].name: float(g_best[i])
