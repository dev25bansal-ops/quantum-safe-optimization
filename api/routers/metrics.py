...
class PrometheusMetrics:
    ...
    def record_job_started(self, problem_type: str):
        ...
        self._jobs_in_progress[problem_type] = (
            self._jobs_in_progress.get(problem_type, 0) + 1
        )
    ...
    def record_job_completed(
        ...
        self._jobs_duration_count[problem_type] = (
            self._jobs_duration_count.get(problem_type, 0) + 1
        )
    ...
    def record_pqc_operation(
        ...
        self._pqc_latency_count[operation] = (
            self._pqc_latency_count.get(operation, 0) + 1
        )
    ...
    def get_metrics(self) -> str:
        ...
        lines.append(f"# HELP {self.namespace}_pqc_operation_duration_seconds PQC operation latency")
        ...
        # WebSocket metrics
        lines.append(f"# HELP {self.namespace}_websocket_connections_total Total WebSocket connections")
        ...
        lines.append(f"# HELP {self.namespace}_websocket_connections_active Active WebSocket connections")
        ...
        lines.append(f'{self.namespace}_websocket_messages_total{{direction="sent"}} {self._ws_messages_sent}')
        lines.append(f'{self.namespace}_websocket_messages_total{{direction="received"}} {self._ws_messages_received}')
        lines.append("")
